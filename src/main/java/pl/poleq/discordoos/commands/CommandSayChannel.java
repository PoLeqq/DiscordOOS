...
public class CommandSayChannel extends ListenerAdapter implements CommandTemplate
{
    private final String COMMAND = Odlaczeni.PREFIX + "saychannel";
    private final String USAGE = Odlaczeni.PREFIX + "saychannel <#kanał>` LUB `;saychannel null`";
    private final String DESCRIPTION = "ustawia kanał, na który ma zostać wysłana wiadomość";

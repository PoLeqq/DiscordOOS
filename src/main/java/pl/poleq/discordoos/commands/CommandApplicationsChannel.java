...
public class CommandApplicationsChannel extends ListenerAdapter implements CommandTemplate
{
    private final String COMMAND = Odlaczeni.PREFIX + "apchannel";
    private final String USAGE = Odlaczeni.PREFIX + "apchannel <#kanał>`";
    private final String DESCRIPTION = "ustawia kanał, który jest odpowiedzialny za kanał do składania podań";
